...
class LedgerBase < ApplicationRecord
  ...
  has_many :link_downs, class_name: :LinkBaseObject, foreign_key: :parent_id
  has_many :descendants, through: :link_downs, source: :child_ledger
  has_many :link_ups, class_name: :LinkBaseObject, foreign_key: :child_ledger_id
