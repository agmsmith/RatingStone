class CreateLedgerAndLinkBases < ActiveRecord::Migration[7.0]
  def change
    ...
    create_table :link_bases, force: false, comment: "LinkBase base class and record for linking LedgerObjects together." do |t|
      ...
      t.float :rating_points_spent, default: -1.0, comment: "The number of points spent on making this link by the creator.  Includes transaction fees."
      t.float :rating_points_boost_parent, default: -1.0, comment: "The number of points used to boost the rating of the parent object."
      t.float :rating_points_boost_child, default: -1.0, comment: "The number of points used to boost the rating of the child object."
